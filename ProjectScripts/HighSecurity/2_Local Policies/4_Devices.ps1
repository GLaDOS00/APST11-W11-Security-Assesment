...
Check-GPSetting -policyPath $RegPath1 -valueName "AllocateDASD" -expectedValue 2 -sectionNumber "2.3.4.1" -level "(L1)" -description "Devices: Allowed to format and eject removable media" -recommendation "Administrators and Interactive Users"

# 2.3.4.2 (L2) Ensure 'Devices: Prevent users from installing printer drivers' is set to 'Enabled'
Check-GPSetting -policyPath $RegPath2 -valueName "AddPrinterDrivers" -expectedValue 1 -sectionNumber "2.3.4.2" -level "(L2)" -description "Devices: Prevent users from installing printer drivers" -recommendation "Enabled"
