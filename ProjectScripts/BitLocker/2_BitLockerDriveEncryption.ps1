...
Check-GPSetting -policyPath $RegPath -valueName "FDVRecoveryPassword" -expectedValue 2 -sectionNumber "18.10.9.1.4" -level "(BL)" -description "Choose how BitLocker-protected fixed drives can be recovered: Recovery Password" -recommendation "Enabled: Allow 48-digit recovery password"
...
Check-GPSetting -policyPath $RegPath -valueName "FDVRecoveryKey" -expectedValue 2 -sectionNumber "18.10.9.1.5" -level "(BL)" -description "Choose how BitLocker-protected fixed drives can be recovered: Recovery Key" -recommendation "Enabled: Allow 256-bit recovery key"
...
Check-GPSetting -policyPath $RegPath -valueName "FDVActiveDirectoryBackup" -expectedValue 0 -sectionNumber "18.10.9.1.7" -level "(BL)" -description "Choose how BitLocker-protected fixed drives can be recovered: Save BitLocker recovery information to AD DS for fixed data drives" -recommendation "Enabled: False"
...
Check-GPSetting -policyPath $RegPath -valueName "FDVRequireActiveDirectoryBackup" -expectedValue 0 -sectionNumber "18.10.9.1.9" -level "(BL)" -description "Choose how BitLocker-protected fixed drives can be recovered: Do not enable BitLocker until recovery information is stored to AD DS for fixed data drives" -recommendation "Enabled: False"
...
Check-GPSetting -policyPath $RegPath -valueName "OSManageDRA" -expectedValue 0 -sectionNumber "18.10.9.2.4" -level "(BL)" -description "Choose how BitLocker-protected operating system drives can be recovered: Allow data recovery agent" -recommendation "Enabled: False"
...
Check-GPSetting -policyPath $RegPath -valueName "OSRecoveryKey" -expectedValue 0 -sectionNumber "18.10.9.2.6" -level "(BL)" -description "Choose how BitLocker-protected operating system drives can be recovered: Recovery Key" -recommendation "Enabled: Do not allow 256-bit recovery key"
...
Check-GPSetting -policyPath $RegPath -valueName "EnableBDEWithNoTPM" -expectedValue 0 -sectionNumber "18.10.9.2.14" -level "(BL)" -description "Require additional authentication at startup: Allow BitLocker without a compatible TPM" -recommendation "Enabled: False"
...
# 18.10.9.3.1 (BL) Ensure 'Allow access to BitLocker-protected removable data drives from earlier versions of Windows' is set to 'Disabled'
 Check-GPSetting -policyPath $RegPath -valueName "RDVDiscoveryVolumeType" -expectedValue $null -sectionNumber "18.10.9.3.1" -level "(BL)" -description "Allow access to BitLocker-protected removable data drives from earlier versions of Windows" -recommendation "Disabled"
...
Check-GPSetting -policyPath $RegPath -valueName "RDVRecoveryPassword" -expectedValue 0 -sectionNumber "18.10.9.3.4" -level "(BL)" -description "Choose how BitLocker-protected removable drives can be recovered: Recovery Password" -recommendation "Enabled: Do not allow 48-digit recovery password"
...
Check-GPSetting -policyPath $RegPath -valueName "RDVRecoveryKey" -expectedValue 0 -sectionNumber "18.10.9.3.5" -level "(BL)" -description "Choose how BitLocker-protected removable drives can be recovered: Recovery Key" -recommendation "Enabled: Do not allow 256-bit recovery key"
...
Check-GPSetting -policyPath $RegPath -valueName "RDVActiveDirectoryBackup" -expectedValue 0 -sectionNumber "18.10.9.3.7" -level "(BL)" -description "Choose how BitLocker-protected removable drives can be recovered: Save BitLocker recovery information to AD DS for removable data drives" -recommendation "Enabled: False"
...
Check-GPSetting -policyPath $RegPath -valueName "RDVRequireActiveDirectoryBackup" -expectedValue 0 -sectionNumber "18.10.9.3.9" -level "(BL)" -description "Choose how BitLocker-protected removable drives can be recovered: Configure storage of BitLocker recovery information to AD DS" -recommendation "Enabled: False"
...
Check-GPSetting -policyPath $RegPath -valueName "RDVDenyCrossOrg" -expectedValue 0 -sectionNumber "18.10.9.3.15" -level "(BL)" -description "Deny write access to removable drives not protected by BitLocker: Do not allow write access to devices configured in another organization" -recommendation "Enabled: False"
